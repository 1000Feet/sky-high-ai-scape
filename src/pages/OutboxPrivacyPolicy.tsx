const OutboxPrivacyPolicy = () => {
  return (
    <div className="min-h-screen bg-slate-950 text-gray-300 py-16 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto prose prose-invert prose-headings:text-white prose-p:text-gray-300 prose-li:text-gray-300 prose-strong:text-white">
        <h1 className="text-3xl font-bold text-white mb-2">Privacy Policy</h1>
        <p className="text-sm text-gray-400 mb-8">Last updated: April 01, 2026</p>
        ...
        <ul>
          ...
          <li><strong>Application</strong> refers to Outbox Chat Translator, the software program provided by the Company.</li>
          <li><strong>Company</strong> (referred to as either "the Company", "We", "Us" or "Our" in this Privacy Policy) refers to 1000 Feet, Inc., 8 The Green, Dover, DE, USA.</li>
        ...
        <h2>Your Rights Under the GDPR (General Data Protection Regulation)</h2>
        ...
        <ul>
          <li><strong>Right of Access:</strong> You have the right to request copies of Your Personal Data. We may charge a small fee for this service.</li>
          <li><strong>Right to Rectification:</strong> You have the right to request that We correct any information You believe is inaccurate. You also have the right to request that We complete information You believe is incomplete.</li>
          ...
          <li><strong>Right to Withdraw Consent:</strong> Where We rely on Your consent to process Your Personal Data, You have the right to withdraw Your consent at any time. Withdrawal of consent does not affect the lawfulness of processing based on consent before its withdrawal.</li>
          <li><strong>Right to Lodge a Complaint:</strong> You have the right to lodge a complaint with a supervisory authority if You believe that Our processing of Your Personal Data infringes the GDPR.</li>
        </ul>

        <h3>Legal Basis for Processing Personal Data Under the GDPR</h3>
        <p>We may process Your Personal Data under the following legal bases:</p>
        <ul>
          <li><strong>Consent:</strong> You have given Your consent for processing Personal Data for one or more specific purposes.</li>
          <li><strong>Performance of a contract:</strong> Processing is necessary for the performance of a contract with You and/or for any pre-contractual obligations thereof.</li>
          <li><strong>Legal obligations:</strong> Processing is necessary for compliance with a legal obligation to which the Company is subject.</li>
          <li><strong>Vital interests:</strong> Processing is necessary in order to protect Your vital interests or those of another natural person.</li>
          <li><strong>Legitimate interests:</strong> Processing is necessary for the purposes of the legitimate interests pursued by the Company, except where such interests are overridden by Your interests or fundamental rights and freedoms.</li>
        </ul>

        <h3>Exercising Your GDPR Rights</h3>
        <p>To exercise any of Your rights under the GDPR, please contact Us at <a href="mailto:angelo@angelomagni.it" className="text-blue-400 hover:text-blue-300">angelo@angelomagni.it</a>. We will respond to Your request within 30 days. We may ask You to verify Your identity before processing Your request.</p>
        ...
        <ul>
          <li>By email: <a href="mailto:angelo@angelomagni.it" className="text-blue-400 hover:text-blue-300">angelo@angelomagni.it</a></li>
        </ul>
      </div>
    </div>
  );
...
export default OutboxPrivacyPolicy;
